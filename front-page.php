...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="wp-content/themes/school/assets/images/favicon.png" type="image/png">

    <!--====== Bootstrap css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/bootstrap.min.css">
    
    <!--====== Animate css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/animate.css">
    
    <!--====== Magnific Popup css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/magnific-popup.css">
    
    <!--====== Slick css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/slick.css">
    
    <!--====== Line Icons css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/LineIcons.css">
    
    <!--====== Default css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/default.css">
    
    <!--====== Style css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/style.css">
    
    <!--====== Responsive css ======-->
    <link rel="stylesheet" href="wp-content/themes/school/assets/css/responsive.css">
...
<body>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.html">
                            <img src="wp-content/themes/school/img/school.jpg" alt="Logo">
                        </a> <!-- Logo -->
                        ...
                        <div class="row no-gutters align-items-center ">
                            <div class="col-lg-4 col-md-5">
                                <div class="slider-product-image d-none d-md-block">
                                    <img src="wp-content/themes/school/img/photodune-1678194-group-of-graduate-students-xxl-1-947x500.jpg" alt="Slider">
                            ...
                            <div class="col-lg-8 col-md-7">
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>Diamond</span><span>School</span></h1>
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="wp-content/themes/school/img/woman-notebook-working-girl-947x500.jpg" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>-20% <br> OFF</p>
                                        </div>
                                    </div> <!-- slider product image -->
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="wp-content/themes/school/img/stephen-bergin-214607-1.jpg" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>FREE<br> QUOTE</p>
                                        </div>
                                    </div> <!-- slider product image -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="wp-content/themes/school/img/pexels-photo-5212345.jpeg" alt="Product">
                        </div> <!-- product image -->
                        <div class="product-content">
                            <h4 class="content-title mb-15">High-quality Education <br> For your child</h4>
                ...
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="wp-content/themes/school/img/pexels-photo-5427651.jpeg" alt="Product">
                        </div> <!-- product image -->
                        <div class="product-content">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="collection-menu text-center mt-30">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="active" id="v-pills-furniture-tab" data-toggle="pill" href="#v-pills-furniture" role="tab" aria-controls="v-pills-furniture" aria-selected="true">management</a>
                        </div> <!-- nav -->
                    </div> <!-- collection menu -->
                </div>
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="wp-content/themes/school/assets/images/product/p-1.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-60%</p>
                                                </div>
                                            </div>
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">About</a></h5>
                                                <ul class="rating">
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="wp-content/themes/school/assets/images/product/p-2.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-20%</p>
                                                </div>
                                            </div>
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">Admissions</a></h5>
                                                <ul class="rating">
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="wp-content/themes/school/assets/images/product/p-3.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-10%</p>
                                                </div>
                                            </div>
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">Academics</a></h5>
                                                <ul class="rating">
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
                                                    <li><i class="lni-star-filled"></i></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-30">
                        ...
                        <h3 class="title mb-15">Why Choose Your School</h3>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-left mt-45">
                        <div class="services">
                            <img src="wp-content/themes/school/assets/images/services/services.jpg" alt="">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center">
                                    ...
                                    <div class="services-content mt-20">
                                        <h5 class="title mb-10">Admissions</h5>
                                ...
                                <div class="single-services text-center mt-30">
                                    ...
                                    <div class="services-content mt-20">
                                        <h5 class="title mb-10">Academics</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm od tempor.</p>
                                    </div>
                                </div> <!-- single services -->
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="showcase-title pt-25">
                        <h2 class="title">Who Should Apply</h2>
                    </div> <!-- showcase title -->
                </div> 
                <div class="col-lg-6">
                    <div class="showcase-title pt-25">
                ...
                <div class="col-lg-12">
                    <div class="showcase-active mt-65">
                        <div class="single-showcase">
                            <img src="wp-content/themes/school/img/pexels-photo-261895.jpeg" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                        <div class="single-showcase">
                            <img src="wp-content/themes/school/img/pexels-photo-5428012.jpeg" alt="Testimonial">
                            <a href="#" class="main-btn">Full Preview</a>
                        </div> <!-- single showcase -->
                    </div> <!-- showcase active -->
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="wp-content/themes/school/assets/images/team/t-1.jpg"
                             alt="Team">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="wp-content/themes/school/assets/images/team/t-2.jpg"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="wp-content/themes/school/assets/images/team/t-3.jpg"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
                ...
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="single-temp text-center mt-30">
                        <div class="team-image">
                            <img src="wp-content/themes/school/assets/images/team/t-4.jpg"
                             alt="Team">
                        </div>
                        <div class="team-content mt-30">
    ...
    <section id="testimonial" class="testimonial-area pt-200">
        <div class="testimonial-bg bg_cover" style="background-image: url(wp-content/themes/school/assets/images/testimonial/ts-bg.jpg)"></div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <img src="wp-content/themes/school/img/photodune-1678194-group-of-graduate-students-xxl-1-947x500.jpg" alt="Blog">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="meta d-flex justify-content-between align-items-center">
                                <div class="meta-admin d-flex align-items-center">
                                    <div class="image">
                                        <a href="#"><img src="wp-content/themes/school/assets/images/blog/admin.jpg" alt="Admin"></a>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-sm-7">
                        <div class="footer-logo mt-40">
                            <a href="#">
                                <img src="wp-content/themes/school/img/logo.jpg" alt="Logo">
                            </a>
...
"text-center text-white mt-5 font-weight-bold">
        ...
        <div class="POPmain"
            ...
            <div id="popup">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputFullName" aria-describedby="FullNameHelp" placeholder="Enter Full Name">
                ...
                <button class="submitId btn btn-primary font-weight-bold mt-5">Subscribe</button>
                <button class="submitId btn btn-primary text-center font-weight-bold mt-5">Close</button>
            </div>
        </div>
        </form>
    ...
    <!--====== jquery js ======-->
    <script src="wp-content/themes/school/assets/js/vendor/modernizr-3.6.0.min.js"></script>
    <script src="wp-content/themes/school/assets/js/vendor/jquery-1.12.4.min.js"></script>

    <!--====== Bootstrap js ======-->
    <script src="wp-content/themes/school/assets/js/bootstrap.min.js"></script>
    
    
    <!--====== Slick js ======-->
    <script src="wp-content/themes/school/assets/js/slick.min.js"></script>
    
    <!--====== Magnific Popup js ======-->
    <script src="wp-content/themes/school/assets/js/jquery.magnific-popup.min.js"></script>

    
    <!--====== nav js ======-->
    <script src="wp-content/themes/school/assets/js/jquery.nav.js"></script>
    
    <!--====== Nice Number js ======-->
    <script src="wp-content/themes/school/assets/js/jquery.nice-number.min.js"></script>
    
    <!--====== Main js ======-->
    <script src="wp-content/themes/school/assets/js/main.js"></script>
